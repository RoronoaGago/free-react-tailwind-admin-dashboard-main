...
export default function UserProfiles() {
  ...
  const getAvatarColor = () => {
    if (!selectedUser) return "bg-gray-500";
    const colors = [
      "bg-blue-500",
      "bg-green-500",
      "bg-purple-500",
    ...
    const hash =
      selectedUser.user_id && typeof selectedUser.user_id === "string"
        ? selectedUser.user_id.charCodeAt(0) +
          selectedUser.user_id.charCodeAt(selectedUser.user_id.length - 1)
        : (typeof selectedUser.first_name === "string"
            ? selectedUser.first_name.charCodeAt(0)
            : 0) +
          (typeof selectedUser.last_name === "string"
            ? selectedUser.last_name.charCodeAt(0)
            : 0);
        ...
        <div className="space-y-6">
          <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex flex-col items-ceFnter w-full gap-6 xl:flex-row">
                <div
